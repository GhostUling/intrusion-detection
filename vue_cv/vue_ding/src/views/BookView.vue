...
<!--由于弹窗组件时挂载在body下的全局组件，为了修改其样式，为其定义了自定义类别，再添加全局style，使得所有el-message-box都改变样式 -->
<style>
/* 全局样式 - 确保弹窗样式生效 */
...
/* 修复关闭按钮位置 */
.custom-upload-dialog .el-message-box__headerbtn {
...
.custom-upload-dialog .el-message-box__close {
  font-size: 18px !important;
  color: #909399 !important;
  transition: color 0.3s !important;
}

.custom-upload-dialog .el-message-box__close:hover {
  color: #333 !important;
}

/* 弹窗内容样式 */
.custom-upload-dialog .el-message-box__content {
...
/* 按钮区域样式 */
.custom-upload-dialog .el-message-box__btns {
  padding: 10px 20px 20px !important;
}

.custom-upload-dialog .el-message-box__btns .el-button {
